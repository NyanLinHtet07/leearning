    ...
    return (
        <>
            <div className="relative mt-7">
                <div className=" bg-gradient-to-b from-primary/30 via-primary/20 to-primaary/5 shadow relative backdrop-blur-md rounded-3xl drop-shadow-sm px-6 py-4 flex justify-around items-center  z-10 h-40 overflow-visible">
                    <div>
                    ...
                    <div className="relative -top-10 w-60 h-60" >
                        <Lottie lottieRef={lottieRef} animationData={Hello} loop={true} className="h-full w-auto" />
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mt-6">
                ...
                <Link href="/student/enrolls">
                    <Card className="group cursor-pointer bg-gradient-to-br form-jade/10 to-jade/40 border-jade/20  hover:shadow-lg transition-all duration-300 ease-out hover:-translate-y-1">
                ...
                <Link href="/student/enrolls">
                    <Card className="group cursor-pointer bg-gradient-to-br from-amber-50 to-shell/80 border border-amber-200 hover:shadow-lg transition-all duration-300 ease-out hover:-translate-y-1">
                        <CardContent className="flex items-center justify-between">
                ...
                <Card className="group cursor-pointer bg-gradient-to-br from-blue-200/50 to-blue-100/50 border-blue-100/20 hover:shadow-lg transition-all duration-300 ease-out hover:-translate-y-1">
                    <CardContent className="flex items-center justify-between">
