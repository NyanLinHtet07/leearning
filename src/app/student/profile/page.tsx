...
import { payloadUser, StudentType } from "@/types/user";
        ...
        <>
            <div className="mt-10 max-w-5xl w-full bg-white/50 rounded-2xl shadow-xl backdrop-blur-md p-8">
                <div className=" flex flex-col md:flex-row items-center md:items-start gap-12">
                    <div className="relative w-36 h-32 rounded-2xl overflow-hidden shadow border border-gray-200 bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center">
                        {studentData?.cover ? (
                            <Image
                                fill
