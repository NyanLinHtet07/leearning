...
export default function TeachersPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['users', { search: searchTerm, page, role: 'teacher' }],
    queryFn: async () => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h2 className="text-2xl font-semibold tracking-tight">Teacher List</h2>
      ...
      <Card className="p-4 space-y-4">
                  ...
                  <tr>
                    <td colSpan={5} className="py-14 px-4 text-center">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <h4 className="text-lg font-semibold text-foreground mb-1">No Teachers Found</h4>
                        <p className="text-sm text-muted-foreground mb-4">Create your first teacher</p>
                      </div>
                    </td>
                  </tr>
                ) : (
        ...
        {/* user-form */}
        <UserForm open={formOpen} onOpenChange={setFormOpen} editingItem={editingItem} form={form} setForm={setForm} onSuccess={handleFormSuccess} isStudent={false} />
